...
-- =====================================================
-- This creates tables that match the existing code structure
-- =====================================================

-- =====================================================
-- STEP 1: CREATE MINISTRIES TABLE (Simple Schema)
-- =====================================================
...
INSERT INTO ministries (name, meeting_day, meeting_time, status) VALUES 
  ('Worship Team', 'Saturday', '4:00 PM', 'Active'),
  ('Ushering Ministry', 'Sunday', '7:30 AM', 'Active'),
  ('Media Ministry', 'Sunday', '6:30 AM', 'Active'),
  ('Children''s Ministry', 'Sunday', '8:00 AM', 'Active'),
  ('Youth Ministry', 'Sunday', '2:00 PM', 'Active'),
  ('Prayer Ministry', 'Wednesday', '6:00 PM', 'Active'),
  ('Evangelism Ministry', 'Saturday', '9:00 AM', 'Active'),
  ('Hospitality Ministry', 'Sunday', '8:00 AM', 'Active'),
...
-- =====================================================
-- STEP 2: CREATE CELL GROUPS TABLE
-- =====================================================
...
INSERT INTO cell_groups (name, meeting_day, meeting_time, location, status) VALUES 
  ('Victory Cell Group', 'Wednesday', '7:00 PM', 'East Legon', 'Active'),
  ('Faith Builders', 'Friday', '6:30 PM', 'Accra Central', 'Active'),
  ('Hope Fellowship', 'Saturday', '4:00 PM', 'Tema', 'Active'),
  ('Grace Circle', 'Thursday', '5:00 PM', 'Kumasi', 'Active'),
  ('Mighty Men', 'Tuesday', '6:00 PM', 'Takoradi', 'Active'),
  ('Youth Fire', 'Sunday', '2:00 PM', 'Cape Coast', 'Active'),
  ('Seniors Circle', 'Monday', '3:00 PM', 'Ho', 'Active'),
  ('New Beginnings', 'Wednesday', '6:00 PM', 'Sunyani', 'Active');
...
-- Create function to generate member codes
